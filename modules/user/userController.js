...
exports.register = async (req, res) => {
    ...
    try {
        ...
        // 2. Verificar se o usuário ou e-mail já existem (opcional, mas melhora o UX)
...
exports.login = async (req, res) => {
    try {
        ...
        // 1. Buscar usuário por email OU usarname
...
exports.renderPublicProfile = async (req, res) => {
    try {
        ...
        // Verificar se o perfil sendo visualizado é o do usuário logado
...
exports.updateProfile = async (req, res) => {
    try {
        ...
        if ( req.file && oldUser.profilePicture && oldUser.profilePicture !== 'default-profile.png' ) {
            const oldPorfilePicParh = path.join(__dirname, '../../public/uploads/profiles', oldUser.profilePicture);
            fs.unlink(oldPorfilePicParh, (err) => {
                if (err) console.error('Erro ao apagar foto de perfil antiga:', err);
                else console.log('Foto de perfil antiga apagada:', oldPorfilePicParh);
            });
        }
